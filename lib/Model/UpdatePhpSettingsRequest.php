...
/**
 * UpdatePhpSettingsRequest Class Doc Comment
 *
 * @category Class
 * @package  Dimer47\LaravelForgeSdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdatePhpSettingsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePhpSettingsRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('max_execution_time', $data ?? [], null);
        $this->setIfExists('opcache', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['max_upload_size']) && ($this->container['max_upload_size'] < 0)) {
            $invalidProperties[] = "invalid value for 'max_upload_size', must be bigger than or equal to 0.";
        }

        if (!is_null($this->container['max_execution_time']) && ($this->container['max_execution_time'] < 0)) {
            $invalidProperties[] = "invalid value for 'max_execution_time', must be bigger than or equal to 0.";
        }
    ...
    public function setMaxUploadSize($max_upload_size)
    {
        ...
        if (!is_null($max_upload_size) && ($max_upload_size < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_upload_size when calling UpdatePhpSettingsRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setMaxExecutionTime($max_execution_time)
    {
        ...
        if (!is_null($max_execution_time) && ($max_execution_time < 0)) {
            throw new \InvalidArgumentException('invalid value for $max_execution_time when calling UpdatePhpSettingsRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets opcache
     *
     * @param bool|null $opcache opcache
     *
     * @return self
     */
