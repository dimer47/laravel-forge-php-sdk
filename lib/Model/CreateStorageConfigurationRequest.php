...
/**
 * CreateStorageConfigurationRequest Class Doc Comment
 *
 * @category Class
 * @package  Dimer47\LaravelForgeSdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateStorageConfigurationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateStorageConfigurationRequest';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateStorageConfigurationRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets assume_role
     *
     * @param string|null $assume_role assume_role
     *
     * @return self
     */
