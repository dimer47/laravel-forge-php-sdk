...
/**
 * CreateDomainCertificateRequestClone Class Doc Comment
 *
 * @category Class
 * @package  Dimer47\LaravelForgeSdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateDomainCertificateRequestClone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateDomainCertificateRequest_clone';
    ...
    */
     ...
     * Sets certificate_id
     *
     * @param int|null $certificate_id The ID of the certificate to clone.
     *
     * @return self
     */
