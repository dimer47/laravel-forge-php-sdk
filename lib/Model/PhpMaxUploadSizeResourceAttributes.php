...
/**
 * PhpMaxUploadSizeResourceAttributes Class Doc Comment
 *
 * @category Class
 * @package  Dimer47\LaravelForgeSdk
 * @author   OpenAPI Generator team
 ...
 */
class PhpMaxUploadSizeResourceAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhpMaxUploadSizeResource_attributes';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['max_upload_size'] === null && !$this->isNullableSetToNull('max_upload_size')) {
            $invalidProperties[] = "'max_upload_size' can't be null";
        }
