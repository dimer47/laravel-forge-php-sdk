...
/**
 * LoadBalancingNodeResourceAttributes Class Doc Comment
 *
 * @category Class
 * @package  Dimer47\LaravelForgeSdk
 * @author   OpenAPI Generator team
 ...
 */
class LoadBalancingNodeResourceAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoadBalancingNodeResource_attributes';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['down'] === null) {
            $invalidProperties[] = "'down' can't be null";
        }
